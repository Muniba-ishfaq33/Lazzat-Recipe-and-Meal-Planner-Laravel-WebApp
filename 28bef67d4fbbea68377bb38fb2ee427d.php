<?php $__env->startSection('title', 'Lazzat | لذّت - Pakistani Recipe Planner'); ?>
...
<section class="hero hero-lazzat" id="home">
  ...
  <div class="hero-showcase" aria-label="Featured Pakistani meals">
    <div class="hero-image-carousel">
      <img class="hero-slide active" src="<?php echo e(asset('images/hero.png')); ?>" alt="Pakistani biryani meal planning hero">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Desktop\LAzzat Not final\resources\views/home.blade.php ENDPATH**/ ?>